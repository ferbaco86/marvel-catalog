...
const fetchCharDetail = () => dispatch => {
  ...
  const apiUrl = `https://gateway.marvel.com/v1/public/characters/${charID}?apikey=${API_KEY}`;
  const seriesApiUrl = `https://gateway.marvel.com/v1/public/characters/${charID}/series?orderBy=-startYear&limit=4&apikey=${API_KEY}`;
  const eventsApiUrl = `https://gateway.marvel.com/v1/public/characters/${charID}/events?orderBy=-startDate&limit=4&apikey=${API_KEY}`;
